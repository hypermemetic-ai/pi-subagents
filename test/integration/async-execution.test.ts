...
describe("async execution utilities", { skip: !available ? "pi packages not available" : undefined }, () => {
	...
	it("persists trusted execution-profile acknowledgement in async result and status", { skip: !isAsyncAvailable() ? "jiti not available" : undefined }, async () => {
		...
		mockPi.onCall({ output: "profiled async done", executionProfileReceipt: receipt });
