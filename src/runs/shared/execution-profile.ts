...
export function combineExecutionProfileReceiptError(
	primaryError: string | undefined,
	receiptError: string | undefined,
): string | undefined {
	return receiptError ? primaryError ? `${primaryError}\nSecondary trusted execution profile receipt failure: ${receiptError}` : receiptError : primaryError;
}
